...
class FreqStack:
    ...
    def push(self, val: int) -> None:
        if val not in self.h_freq:
            ...
            self.h_freq[val] += 1
            if self.maxf < self.h_freq[val]:
                self.maxf = self.h_freq[val]
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjIxNjc1NDMsMTU1NzQ5ODAzNyw4MD
k2NjM3NSw1NzgyMzQyOCwxOTU0OTI4NzUwLC0zMTA0MTE2MzEs
MTg3NTcxNTQxNSwtMTY4Nzg1Mjc3NiwyMTI4NzY4MzEyLC03Nj
kzMTgyMDcsODY5NTgwNjc2LC0zNDUyNzE0NDgsMTE1NzkxNzMy
MCwtMTU1MDc1NDAzNV19
-->