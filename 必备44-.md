...
最好是让结果高位是1，所以用前缀树找最优的二进制
比如110那么就要找001

每个数二进制都建前缀树，pass和end都不需要，只要结构就行
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ4Mzg4MTcsLTE3NDkzMDg5ODUsLTEyMj
U2MzEyODQsMjM3MTMwNjgsMzU3MjcwMTY0LC01OTYxNzk4Njgs
MTc5OTMyMjEwMF19
-->